...
a persistence unit "fundPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "fund\pom.xml":
...
artifact ("fund.war") is already built. You can build
